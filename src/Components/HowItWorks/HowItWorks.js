        ...
        return (
            <div style={styles} fluid>
                ...
                <div style={stylesBusinessDiv} >
                        <Row>
                            <Col xs={12} lg={6}><img className="hero-image hvr-buzz-out" src={FoodTable} alt="hero-image" /></Col>

                            <Col xs={12} lg={6}><img className="hero-image hvr-buzz-out" src={FoodPicker} alt="hero-image" /></Col>

                            <Col xs={12} lg={6}><img className="hero-image hvr-buzz-out" src={Shopping} alt="hero-image"/></Col>

                            <Col xs={12} lg={6}><img className="hero-image hvr-buzz-out" src={Dinner} alt="hero-image" /></Col>
                        </Row>
