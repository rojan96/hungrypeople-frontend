    ...
    render(){
        return(
            <Container style = {styles} fluid>
                <h1>What we do</h1>
                <h3>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque porttitor ac lorem eget sagittis. Fusce tincidunt condimentum placerat. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Proin eleifend elit eu scelerisque pretium. Nullam pretium nisi non mauris convallis scelerisque. Suspendisse venenatis semper turpis, eget molestie turpis molestie id. Duis faucibus pellentesque magna, nec luctus nulla pharetra vel.</h3>

                    <h3>Ut lacinia et lorem nec lacinia. Aliquam erat volutpat. Morbi tempus quis justo in posuere. Ut vitae libero a nisi gravida ultricies. Nunc tincidunt gravida lorem ut bibendum. Donec ornare est at hendrerit tempus. Morbi vitae sapien at arcu vestibulum ultricies nec vitae urna.</h3>
            </Container>
        );
    }
}
